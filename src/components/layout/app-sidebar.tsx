  ...
  return (
    ...
    >
      ...
      >
        ...
        {/*
          A button, not a link: signing out is an action that clears a session,
          not a destination. Inert until an auth provider is chosen — the
          handler goes here and the session gate is in `src/proxy.ts`.
        */}
        <button
          type="button"
